      ...
      if (shouldTrigger) {
        ...
        if (!existingAlert) {
          addNotification({
            ...
            message: `PGAUx price is ${alert.type} ${formatCurrency(alert.price)}`,
    ...
    const sampleNotifications: Notification[] = [
      {
        ...
        message: 'Your account has been successfully set up. Start trading PGAUx tokens now!',
      ...
      },
      {
        ...
        message: 'Successfully minted 50.00 PGAUx tokens',
        ...
        <div className="absolute right-0 top-full mt-2 w-96 bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 z-50">
          ...
          {showSettings && (
            <div className="p-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
              <h4 className="font-medium text-gray-900 dark:text-white mb-3">Price Alerts</h4>
